...
\begin{protocol}
    \caption{$\textsf{SelectChain}(P, \text{sid}, \mathcal{C}_{\text{loc}}, R, K_{\text{f}}, K_{\text{g}}, \mathfb{N}_0,$
    ...
    \begin{algorithmic}[1]
        ...
        \For {each $\mathcal{C} \in \mathbf{N}_0$}
            \State Set $\textsf{is\_valid\_chain} \leftarrow \textsf{IsValidChain}(P, \text{sid}, \mathcal{C}, R, l_{\text{VRF}}, K_{\text{f}},  \{S_k^{\text{id}}\}_{k=1}^K,$
