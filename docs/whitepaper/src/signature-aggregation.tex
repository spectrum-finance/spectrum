...
As long as Handel requires that the partial aggregation function satisfies both \empth{commutativity} and \empth{associativity} conditions we have to replace \empth{lists} with \empth{sets}.
