use elliptic_curve::{CurveArithmetic, FieldBytes, NonZeroScalar, ProjectivePoint, PublicKey, Scalar, ScalarPrimitive};
...
pub fn proof_to_random_number<TCurve: CurveArithmetic + PointCompression>(proof: ECVRFProof<TCurve>, vrf_range: i8)
                                                                          -> i64
